...
public class PrimitiveDataTypes2 {
	...
	public static void main(String[] args) {
		...
		char char7 = 123;
		System.out.println(char7); // prints the character that ha s the number of 123 from ASCII Table
		
		
		
		//initializing char to the other primitives: byte, short, int, long, float, double 
			char	 MyChar1 	= 'b';
			//	   variablename    value
			...
			//byte MyByte = MyChart1 ;  // char' memory is 2 bytes, byte' memory is 1 byte 
			byte MyByte2 ='b'; // b's  corresponding number is 98 from ASCII Table
			System.out.println(MyByte2);
			
				
			//short ShortNum = MyChar1; // char' memory is could be bigger than short, range is grater than short
			short ShortNum2 = 'b';	// b' corresponding number is 98 from ASCII Table
