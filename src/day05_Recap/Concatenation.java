...
public class Concatenation {
	...
	/*
	 * 
	 String	:Represent the sequences of characters, used for storing text
	 		String values are surrendered by a double quote
	 				
	 Concatenation: Combining, linking things together ==> craters a String value
	 				achieved by using 	+ operator
	 				we can contact any value to String
	...
	// Example:
		...
		System.out.println(2-1+1+"4");		// 1+1+"4" = 2+"4" => 24
			...
			System.out.println("3" + '3' );	// "3" + 3
											// if we contact char to String, char is contacted as character 
											// "3" + 3	
			
			System.out.println( 12 + '3' ); // 12+ 51 = 63
											// if we contact char to number, representive number of char will be contacted
