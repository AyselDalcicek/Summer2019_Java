...
public class WarmUp_ArrayListMax_Min_etc {
	 /*
    Warm Up: 
   ...
   public static void main(String[] args) {
       // task01:
           ...
           System.out.println(list); // [1, 2, 3, 4, 5]
                       // OR
           System.out.println( ArrayToArrayList(arr) ); // [1, 2, 3, 4, 5]
	           ...
	           System.out.println(list2);  // [1.5, 2.5, 3.5]
	           			  // OR
	           System.out.println( ArrayToArrayList(arr2));//  [1.5, 2.5, 3.5]
...
ArrayList<Integer> list4 = new ArrayList<Integer>(Arrays.asList( 10, 20, 35, 30, 35));
       ...
       int secondMaximum  = SecondMax(list4);  // 30
           ...
           System.out.println( secondMaximum );  // 30
   ...
   // Task01 - 1. write a return method that accepts an int array and returns it as an ArrayList
   ...
   // task02 -  2. write a return method that accepts an Integer arrayList and returns the max num
   ...
   // task03 - 3. write a return method that accepts an Integer arrayList and returns the sec max num
   ...
   // task04: - 4. write a return method that accepts an Integer array and returns the  min num
