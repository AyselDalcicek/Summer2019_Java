...
public class ArrayListReview {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(list); // [10, 30, 20, 50]
 ...
 System.out.println("============================");
    // size(): returns the total number of elements in the list ( similar with lenght method in array
        ...
        for(int i = 0; i < list.size(); i++) {
            System.out.print(list.get(i)+" "); //  10 30 20 50  
        }
...
System.out.println("-----------------------------");
        ...
        ArrayList<String> students = new ArrayList<>();
                ...
                System.out.println(students); // [Erhan, Homayra, Rahwa, Arzu, Mehmet, Rahwa]
                
                students.set(0, "Holly");
                System.out.println(students);  // [Holly, Homayra, Rahwa, Arzu, Mehmet, Rahwa]
